<#
.SYNOPSIS
    Headless screenshot harness for Master Thief.

.DESCRIPTION
    Thin wrapper around the shared macroquad-toolkit capture script. Builds the
    debug exe and drives it through the env-var capture hook
    (MASTER_THIEF_CAPTURE_*) provided by macroquad_toolkit::capture in
...
& $shared -GameDir $gameDir -Prefix "MASTER_THIEF" -Scenes $Scenes -Frames $Frames -OutputDir $OutputDir -SkipBuild:$SkipBuild
